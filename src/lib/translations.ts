...
export const translations = {
  en: {
    ...
    // Diwali Markets
    diwaliBannerTitle: "🎆 Diwali Markets 2025 — Women Entrepreneurs Showcase",
    diwaliBannerSubtitle: "Special festive stalls in Pune (Tue–Sun) & Mumbai (Wed–Sun). Apply now!",
    applyForStall: "Apply for Stall",
    viewSchedule: "View Schedule",
    diwaliHeroTitle: "Diwali Markets for Women Entrepreneurs",
    diwaliHeroSubtitle: "Showcase your festive products to thousands of shoppers. Limited stalls each day.",
    diwaliDates: "Diwali Market Dates",
    ...
    shopDiwaliSpecials: "Shop Diwali Specials",
    diwaliMapTitle: "Diwali Market Locations",
    diwaliFaqTitle: "Frequently Asked Questions",
    faqWhatCanISell: "What can I sell?",
    faqWhatCanISellAnswer: "You can sell handmade products, traditional foods (with FSSAI), handicrafts, apparel, home décor, and festive items. All products must be suitable for Diwali shoppers.",
  ...
  mr: {
    ...
    // Diwali Markets
    diwaliBannerTitle: "🎆 दिवाळी बाजार 2025 — महिला उद्योजक प्रदर्शन",
    diwaliBannerSubtitle: "पुणे (मंगळवार-रविवार) आणि मुंबई (बुधवार-रविवार) मध्ये विशेष सणाचे स्टॉल. आता अर्ज करा!",
    applyForStall: "स्टॉलसाठी अर्ज करा",
    viewSchedule: "वेळापत्रक पहा",
    diwaliHeroTitle: "महिला उद्योजकांसाठी दिवाळी बाजार",
    diwaliHeroSubtitle: "हजारो खरेदीदारांना तुमची सणाची उत्पादने दाखवा. प्रत्येक दिवशी मर्यादित स्टॉल.",
    diwaliDates: "दिवाळी बाजाराच्या तारखा",
    ...
    shopDiwaliSpecials: "दिवाळी स्पेशल खरेदी करा",
    diwaliMapTitle: "दिवाळी बाजार स्थाने",
    diwaliFaqTitle: "वारंवार विचारले जाणारे प्रश्न",
  ...
  hi: {
    ...
    // Diwali Markets
    diwaliBannerTitle: "🎆 दिवाली बाजार 2025 — महिला उद्यमी प्रदर्शनी",
    diwaliBannerSubtitle: "पुणे (मंगलवार-रविवार) और मुंबई (बुधवार-रविवार) में विशेष त्योहारी स्टॉल। अभी आवेदन करें!",
    applyForStall: "स्टॉल के लिए आवेदन करें",
    viewSchedule: "कार्यक्रम देखें",
    diwaliHeroTitle: "महिला उद्यमियों के लिए दिवाली बाजार",
    diwaliHeroSubtitle: "हजारों खरीदारों को अपने त्योहारी उत्पाद दिखाएं। प्रत्येक दिन सीमित स्टॉल।",
    diwaliDates: "दिवाली बाजार की तारीखें",
    vendorEligibility: "विक्रेता पात्रता",
    ...
    shopDiwaliSpecials: "दिवाली स्पेशल खरीदें",
    diwaliMapTitle: "दिवाली बाजार स्थान",
    diwaliFaqTitle: "अक्सर पूछे जाने वाले प्रश्न",
