      ...
      <div className="container px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="group relative text-center p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-primary/5 via-card to-primary/10 
            ...
            >
              ...
              <div className="relative z-10">
                <div className="inline-flex p-3 sm:p-4 rounded-full bg-primary/10 group-hover:bg-primary/20 
                                transition-all duration-300 mb-3 sm:mb-4 group-hover:scale-110 group-hover:rotate-6">
                  <stat.icon className="h-8 w-8 sm:h-10 sm:w-10 text-primary group-hover:scale-110 transition-transform duration-300" />
                </div>
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold mb-1 sm:mb-2 bg-gradient-to-r from-primary to-primary/70 
